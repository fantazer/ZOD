...
$('.main-menu-toggle').click(function(){
 ...
 //    navigationText : ["<i class='fa fa-angle-left '></i>","<i class='fa fa-angle-right '></i>"],
  ...
  //   navigationText : ["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],
	...
	$('.catalog-main-el-top-img a,.slider-proj-mainEl-img a,.service-slider a,.catalog-main-el-top-left a, .Garant-slider-cert-wrap a,.about-comand a,.about-partners a').fancybox();
...
$('#validateform').validate({
	...
	$('.garant-rewiev .owl-wrapper-outer').addClass('garant-rewiev-height');
	$( window ).resize(function() {
	  if ($(window).width() <= '600'){
			$('.garant-rewiev .owl-wrapper-outer').removeClass('garant-rewiev-height')
		}else{
			$('.garant-rewiev .owl-wrapper-outer').addClass('garant-rewiev-height')
		}
	});
